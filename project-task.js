...
console.log("The sum of 5 and 10 is " + sumOf2Numbers(5,10));

// Script 3 - Product calculation
function productOf2Numbers(num1,num2) {
   return num1 * num2;
}
console.log("The product of 5 and 10 is " + productOf2Numbers(5,10));
